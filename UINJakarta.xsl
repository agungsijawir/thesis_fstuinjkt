    ...
    <xsl:template name="StringFormatDot">
        ...
        <xsl:choose>
            ...
            <xsl:when test="substring($format, 1, 1) = '%'">
                ...
                <xsl:apply-templates select="msxsl:node-set($parameters)/t:params/t:param[position() = $pos]"
                                     mode="outputHtml2"/>
                <xsl:call-template name="StringFormatDot">
                    <xsl:with-param name="format" select="substring($format, 3)"/>
                    <xsl:with-param name="parameters" select="$parameters"/>
    ...
    <xsl:template match="/">
        ...
        <xsl:choose>
            ...
            <xsl:when test="b:OfficeStyleKey">
                <xsl:text>APA - FST UIN Jakarta</xsl:text>
            </xsl:when>
            ...
            <xsl:when test="b:StyleNameLocalized">
                <xsl:choose>
                    ...
                    <xsl:when test="b:StyleNameLocalized/b:Lcid='1060'">
                        <xsl:text>Standard APA - FST UIN Jakarta</xsl:text>
                    </xsl:when>
                </xsl:choose>
            </xsl:when>
                    ...
                    <body>
                        ...
                        <xsl:element name="p">
                            ...
                            <xsl:variable name="type">
                                <xsl:value-of
                                        select="msxsl:node-set($ListPopulatedWithMain)/b:Citation/b:Source/b:SourceType"/>
                            </xsl:variable>

                            <xsl:variable name="title0">
                                <xsl:choose>
                                    <xsl:when
                                            test="string-length(msxsl:node-set($ListPopulatedWithMain)/b:Citation/b:Source/b:ShortTitle)>0">
                                        <xsl:value-of
                            ...
                            <xsl:variable name="year0">
                                <xsl:value-of
                                        select="msxsl:node-set($ListPopulatedWithMain)/b:Citation/b:Source/b:Year"/>
                            </xsl:variable>

                            <xsl:variable name="authorMain">
                                <xsl:copy-of
                                        select="msxsl:node-set($ListPopulatedWithMain)/b:Citation/b:Source/b:Author/b:Main"/>
                            </xsl:variable>

                            <xsl:variable name="patentNumber">
                                <xsl:value-of
                                        select="msxsl:node-set($ListPopulatedWithMain)/b:Citation/b:Source/b:PatentNumber"/>
                            </xsl:variable>

                            <xsl:variable name="countryRegion">
                                <xsl:value-of
                                        select="msxsl:node-set($ListPopulatedWithMain)/b:Citation/b:Source/b:CountryRegion"/>
                            </xsl:variable>
                            ...
                            <xsl:variable name="author0">
                                <xsl:choose>
                                    <xsl:when
                                            test="string-length(msxsl:node-set($ListPopulatedWithMain)/b:Citation/b:Source/b:Author/b:Main/b:Corporate) > 0">
                                        <xsl:value-of
                                            ...
                                            <xsl:if test="$cAuthors &lt;= $maxCitationAuthors">
                                                <xsl:if test="position() = $cAuthors - 1">
                                                    ...
                                                    <xsl:if test="$cAuthors > 2">
                                                        ...
                                                        <xsl:choose>
                                                            <xsl:when
                                                                    test="$noCommaBeforeAnd != 'yes' or $noAndBeforeLastAuthor = 'yes'">
                            ...
                            <xsl:variable name="volume"
                                          select="msxsl:node-set($ListPopulatedWithMain)/b:Citation/b:Volume"/>
                            ...
                            <xsl:variable name="pages"
                                          select="msxsl:node-set($ListPopulatedWithMain)/b:Citation/b:Pages"/>
                            ...
                            <xsl:if test="string-length($author0) = 0 and string-length($title0) = 0 and string-length($year0) = 0">
                                <xsl:value-of
                                        select="msxsl:node-set($ListPopulatedWithMain)/b:Citation/b:Source/b:Tag"/>
                            </xsl:if>
                            ...
                            <xsl:element name="p">
                                ...
                                <xsl:variable name="ppPages">
                                    <xsl:if test="string-length($pages)>0">
                                        <xsl:choose>
                                            <xsl:when
                                                    test="not(string-length($pages)=string-length(translate($pages, ',', '')))">
                                                <xsl:call-template name="templ_str_PagesCountinousShort"/>
                                            </xsl:when>
                                            <xsl:when
                                                    test="string-length($pages)=string-length(translate($pages, $prop_APA_Hyphens, ''))">
                                ...
                                <xsl:variable name="theEditorEnc">
                                    <xsl:if test="string-length($theEditorEncTemp)>0">
                                        <xsl:value-of
                                                select="substring($theEditorEncTemp, 1 + string-length($prop_APA_GeneralOpen), string-length($theEditorEncTemp) - string-length($prop_APA_GeneralOpen) - string-length($prop_APA_GeneralClose))"/>
                                    </xsl:if>
                                </xsl:variable>
                                ...
                                <xsl:variable name="theBookAuthorAndEditorDot">
                                    <xsl:if test="string-length($theBookAuthorAndEditor)>0">
                                        <xsl:value-of
                                                select="substring($theBookAuthorAndEditor, 1 + string-length($prop_APA_GeneralOpen), string-length($theBookAuthorAndEditor) - string-length($prop_APA_GeneralOpen) - string-length($prop_APA_GeneralClose))"/>
                                        <xsl:call-template name="templ_prop_Dot"/>
                                    </xsl:if>
                                </xsl:variable>
                                    ...
                                    <xsl:if test="string-length($bookTitle)>0">
                                        <xsl:call-template name="ApplyItalicFieldNS">
                                            <xsl:with-param name="data">
                                                <xsl:choose>
                                                    <xsl:when
                                                            test="string-length($volume)>0 or string-length($pages)>0 or string-length($translator)>0 or string-length($edition)>0">
                                ...
                                <xsl:variable name="writePerfPerformer">
                                    <xsl:choose>
                                        <xsl:when test="string-length($writer)>0 or string-length($director)>0">
                                            Performer
                                        </xsl:when>
                                    </xsl:choose>
                                </xsl:variable>
                                ...
                                <xsl:variable name="source">
                                    <xsl:choose>
                                            ...
                                            <xsl:choose>
                                                <xsl:when test="string-length($theAuthorDot)>0">
                                                    ...
                                                    <xsl:if test="string-length($i_titleEditionVolumeDot)>0">
                                                        <xsl:call-template name="templ_prop_Space"/>
                                                        <xsl:apply-templates
                                                                select="msxsl:node-set($i_titleEditionVolumeDot)"
                                                                mode="outputHtml"/>
                                                    </xsl:if>
                                        ...
                                        <xsl:when test="b:SourceType='BookSection'">
                                            ...
                                            <xsl:if test="string-length($i_bookTitlePagesDot)>0">
                                                <xsl:choose>
                                                    ...
                                                    <xsl:when
                                                            test="string-length($authorDot)>0 or string-length($titleDot)>0 or string-length($theBookAuthorAndEditorDot)>0 or string-length($enclosedDateDot)>0">
                                                        <xsl:call-template name="templ_prop_Space"/>
                                                    </xsl:when>
                                                </xsl:choose>
                                                ...
                                                <xsl:if test="string-length($theBookAuthorAndEditor)>0">
                                                    <xsl:apply-templates select="msxsl:node-set($i_bookTitlePagesDot)"
                                                                         mode="outputHtml"/>
                                                </xsl:if>
                                            </xsl:if>
                                            ...
                                            <xsl:choose>
                                                <xsl:when test="string-length($theAuthorDot)>0">
                                                    ...
                                                    <xsl:if test="string-length($tempJVIP)>0">
                                                        <xsl:call-template name="templ_prop_Space"/>
                                                        <xsl:apply-templates select="msxsl:node-set($tempJVIP)"
                                                                             mode="outputHtml"/>
                                                    </xsl:if>
                                                </xsl:when>
                                            ...
                                            <xsl:choose>
                                                <xsl:when test="string-length($theAuthorDot)>0">
                                                    ...
                                                    <xsl:if test="string-length($tempPTVI)>0">
                                                        <xsl:call-template name="templ_prop_Space"/>
                                                        <xsl:apply-templates select="msxsl:node-set($tempPTVI)"
                                                                             mode="outputHtml"/>
                                                    </xsl:if>
                                                </xsl:when>
                                                                        ...
                                                                        <xsl:if test="string-length($conferenceNameDot)>0">
                                                                            ...
                                                                            <xsl:call-template
                                                                                ...
                                                                                <xsl:with-param name="data">
                                                                                    <xsl:choose>
                                                                                        <xsl:when
                                                                                                test="((string-length($volume)=0 and string-length($pages)>0) or (string-length($publisher)=0 and (string-length($volume)>0 or string-length($pages)>0)))">
                                                                                            <xsl:value-of
                                                                                                    select="$conferenceName"/>
                                                                                        </xsl:when>
                                                                                        <xsl:otherwise>
                                                                                            <xsl:value-of
                                                                                                    select="$conferenceNameDot"/>
                                                                                        </xsl:otherwise>
                                                                                    </xsl:choose>
                                                                                </xsl:with-param>
                                                                            </xsl:call-template>
                                            ...
                                            <xsl:choose>
                                                <xsl:when test="string-length($theAuthorDot)>0">
                                                    ...
                                                    <xsl:if test="string-length($tempTV)>0">
                                                        <xsl:call-template name="templ_prop_Space"/>
                                                        <xsl:apply-templates select="msxsl:node-set($tempTV)"
                                                                             mode="outputHtml"/>
                                                    </xsl:if>
                                            ...
                                            <xsl:if test="string-length($patentNumberDot)>0">
                                                <xsl:call-template name="ApplyItalicFieldNS">
                                                    <xsl:with-param name="data">
                                                        ...
                                                        <xsl:call-template name="StringFormatDot">
                                                            <xsl:with-param name="format"
                                                                            select="$str_PatentNumberShortCap"/>
                                                            <xsl:with-param name="parameters">
                                                                <t:params>
                                                                    <t:param>
                                                                        <xsl:value-of select="$patentNumber"/>
                                            ...
                                            <xsl:choose>
                                                <xsl:when test="string-length($theMiscAuthorDot)>0">
                                                    ...
                                                    <xsl:if test="string-length($tempPVIEP)>0">
                                                        <xsl:call-template name="templ_prop_Space"/>
                                                        <xsl:apply-templates select="msxsl:node-set($tempPVIEP)"
                                                                             mode="outputHtml"/>
                                                    </xsl:if>
                                                    ...
                                                    <xsl:if test="string-length($theMiscEditorAndTranslatorAndCompilerDot)>0">
                                                        <xsl:call-template name="templ_prop_Space"/>
                                                        <xsl:value-of
                                                                select="$theMiscEditorAndTranslatorAndCompilerDot"/>
                                                    </xsl:if>
                                            ...
                                            <xsl:choose>
                                                ...
                                                <xsl:when test="string-length($theAuthorDot)=0">
                                                    ...
                                                    <xsl:if test="string-length($tempPVEP)>0">
                                                        ...
                                                        <xsl:apply-templates select="msxsl:node-set($tempPVEP)"
                                                                             mode="outputHtml"/>
                                                    </xsl:if>
                                        ...
                                        <xsl:when test="b:SourceType='Film'">
                                            ...
                                            <xsl:choose>
                                                <xsl:when
                                                        test="string-length($theFilmProducerAndWriterAndDirectorDot)>0">
                                            ...
                                            <xsl:choose>
                                                <xsl:when test="string-length($broadcaster)=0">
                                                    ...
                                                    <xsl:if test="string-length($tempPrP)>0">
                                                        ...
                                                        <xsl:apply-templates select="msxsl:node-set($tempPrP)"
                                                                             mode="outputHtml"/>
                                                    </xsl:if>
                                                    ...
                                                    <xsl:if test="string-length($theInterviewInterviewerAndEditorAndTranslator)>0">
                                                        ...
                                                        <xsl:value-of
                                                                select="$theInterviewInterviewerAndEditorAndTranslator"/>
                                                    </xsl:if>
                ...
                <xsl:element name="{'b:Source'}">
                    ...
                    <b:SortingString>
                        ...
                        <xsl:variable name="author">
                            <xsl:choose>
                                <xsl:when
                                        test="string-length(./b:Author/*[local-name()=$MostImportantAuthorLocalName]/b:Corporate) > 0">
                                    <xsl:value-of
                    ...
                    <b:Author>
                        ...
                        <b:Main>
                            <xsl:if test="string-length(./b:Author/*[local-name()=$MostImportantAuthorLocalName]/b:Corporate)=0">
                                <b:NameList>
                                    <xsl:for-each
                                            select="./b:Author/*[local-name()=$MostImportantAuthorLocalName]/b:NameList/b:Person">
                                        <b:Person>
    ...
    <xsl:template name="formatNameCore">
        ...
        <xsl:variable name="format">
            <xsl:choose>
                ...
                <xsl:when
                        test="string-length($first) = 0 and string-length($middle) = 0 and string-length($last) != 0 ">
